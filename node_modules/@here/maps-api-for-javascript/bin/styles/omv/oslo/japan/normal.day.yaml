...
global:
  ...
  # Uses Hiragino Sans MacOS system font & Meiryo, Yu Gothic, MS Gothic as Windows system fonts, DroidSansFallback as overall fallback for CJK glyphs
  text_font_family: 'FiraGO, Hiragino Sans, Meiryo, Yu Gothic, MS Gothic, DroidSansFallback'
  ux_language: ja
  ...
  boundary:
    IPC:
      region:
        ...
        outline:
          color: [
            [6, "rgba(243,206,219,0.08)"],
            [11, "rgba(230,191,198,0.16)"],
            [16, "rgba(215,168,181,0.30)"]
          ]
    municipality:
      line:
        ...
        outline:
          # MunicipalityBoundary.BackgroundColor
          color: [
            [12, "rgba(246,221,238,0.12)"],
            [13, "rgba(243,211,231,0.25)"],
            [16, "rgba(219,171,199,0.25)"]
          ]
    ...
    district:
      line:
        ...
        outline:
          ...
          color: [
            [14, "rgba(246,212,230,0.12)"],
            [15, "rgba(230,189,211,0.27)"],
            [17, "rgba(226,201,220,0.31)"],
          ]
    ...
    neighbourhood:
      line:
        ...
        outline:
          # NeighbourhoodBoundary.BackgroundColor
          color: [
            [15, "rgba(227,204,221,0.18)"],
            [16, "rgba(229,204,219,0.20)"],
            [18, "rgba(226,201,217,0.31)"],
          ]
    ...
    microhood:
      line:
        ...
        dash_background_color: rgba(224, 207, 190, .28)
        outline:
          # MicrohoodBoundary.BackgroundColor
          color: [
            [17, "rgba(229,204,219,0.20)"],
            [18, "rgba(226,204,220,0.31)"],
          ]
